(() => {
  ...
  /* The shared entrance system lives in the global script, which runs in the
     footer. This class is what arms its hidden starting states, and it is set
     here - inline, part way down the page - so nothing is ever painted
     visible and then snatched away. */
